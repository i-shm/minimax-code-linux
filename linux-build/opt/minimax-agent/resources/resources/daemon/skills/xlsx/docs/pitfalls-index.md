...
>
> - `<SKILL>` → `/Users/<user>/.mavis*/.builtin-skills/xlsx`
> - `<SKILL_PDF>` → `/Users/<user>/.mavis*/.builtin-skills/pdf`
...
## X2 — Multi-format deliverable (Excel + PDF + Word) via mavis-team
...
STEP 2 — Build mavis-team plan with explicit setup budget
